...
anecdotal_old <- read.csv("Colombia Data/Anecdotal annual with municipality.csv") %>% as_tibble
...
anecdote_sources_unique <- read_xlsx("Colombia Data/anecdotal source location names unique Galia checked (12-20-2024).xlsx")
anecdote_destinations_unique <- read_xlsx("Colombia Data/anecdotal destination location names unique Galia checked (12-20-2024).xlsx")
}
